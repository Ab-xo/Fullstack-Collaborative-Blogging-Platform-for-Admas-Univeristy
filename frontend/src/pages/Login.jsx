          ...
          >
            <div className="relative z-10 max-w-md">
              ...
              <p className="text-lg text-gray-600 dark:text-gray-400 mb-8">
                Sign in to continue sharing knowledge and connecting with fellow
                academics.
              </p>
          ...
          >
            <div className="w-full max-w-md">
              ...
              <div className="relative">
                ...
                <div className="relative glass rounded-2xl shadow-2xl border border-gray-200 dark:border-white/20 p-6 sm:p-8">
