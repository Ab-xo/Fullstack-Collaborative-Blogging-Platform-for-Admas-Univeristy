/**
 * ============================================================================
 * PUBLISHED POSTS PAGE - View Recently Published Content
 * ============================================================================
 */
...
const PublishedPosts = () => {
  ...
  const stats = {
    ...
    totalComments: posts.reduce(
      (sum, p) => sum + (p.commentsCount || p.comments?.length || 0),
      0
    ),
  };
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-10 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-gray-900 dark:text-white"
              />
              {searchQuery && (
                <button
            ...
            <select
              ...
              className="px-4 py-3 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-600 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 text-gray-900 dark:text-white"
            >
              <option value="publishedAt">Recently Published</option>
              <option value="views">Most Views</option>
              <option value="likesCount">Most Likes</option>
              <option value="commentsCount">Most Comments</option>
            </select>
          </div>
        </motion.div>
                ...
                <div className="p-6">
                  <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    {post.featuredImage ? (
                      ...
                      <div className="w-full lg:w-32 h-32 bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 rounded-xl flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-4 mb-2">
                        ...
                        <span className="flex-shrink-0 px-3 py-1 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 text-xs font-medium rounded-full">
                          Published
                        </span>
                      </div>
            ...
            >
              ...
              >
                ...
                <div className="p-6 overflow-y-auto max-h-[60vh]">
                  ...
                  <div className="flex items-center gap-6 mb-6 p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
                    ...
                    <div className="text-center">
                      <p className="text-2xl font-bold text-pink-600">
                        {(previewPost.likesCount || 0).toLocaleString()}
                      </p>
                      <p className="text-xs text-gray-500">Likes</p>
                    </div>
                    <div className="text-center">
                      <p className="text-2xl font-bold text-green-600">
                        {(previewPost.commentsCount || 0).toLocaleString()}
                      </p>
                ...
                <div className="p-6 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
                  <button
                    onClick={() =>
                      window.open(`/posts/${previewPost._id}`, "_blank")
                    }
